...
public abstract class lr_parser {
	...
	public abstract Symbol do_action(int act_num, lr_parser parser,
			@SuppressWarnings("rawtypes") Stack stack, int top) throws java.lang.Exception;
	...
	public void dump_stack(PrintStream xml) {
		/*
		if (stack == null) {
		...
		for (int i = 0; i < stack.size(); i++) {
			...
			xml.println("<state num=\""
					+ ((Symbol) stack.elementAt(i)).parse_state + "\">");
			if (stack.elementAt(i) instanceof sic2intel_compiler.lexer.PascalSym) {
				((sic2intel_compiler.lexer.PascalSym) (stack.elementAt(i))).toXML(xml);
			} else {
				if (i == 0) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Symbol debug_parse(java.io.PrintStream out)
			throws java.lang.Exception {
		/* the current action code */
		int act;
